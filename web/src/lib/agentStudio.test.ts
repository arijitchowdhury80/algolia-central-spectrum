...
/**
 * These fixtures are pasted VERBATIM from a real empirical capture of the
 * live stream. Do not synthesize these — the whole point of that
 * investigation was that the wire shape ≠ the docs shape.
 */
...
describe('parseCompletionStream — no regression on already-handled frames', () => {
  // Real frames from the ordinary capture, trimmed.
