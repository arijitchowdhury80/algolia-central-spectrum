...
/**
 * Fixtures for tests 2/3/5 are pasted VERBATIM from a real captured live
 * probe. Do not synthesize these — same discipline agentStudio.test.ts
 * already established for its own real captured suggestion frames ("Do not
 * synthesize these — the whole point was that the wire shape ≠ the docs
 * shape").
 */
